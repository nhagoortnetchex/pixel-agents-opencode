...
// ── Timing (ms) ──────────────────────────────────────────────
export const DB_POLL_INTERVAL_MS = 500;
export const SESSION_DISCOVERY_INTERVAL_MS = 2000;
export const TOOL_DONE_DELAY_MS = 300;
export const PERMISSION_TIMER_DELAY_MS = 7000;
export const TEXT_IDLE_DELAY_MS = 5000;
export const RESTORE_LOOKBACK_MS = 30_000;
...
// ── OpenCode Database ───────────────────────────────────────
export const OPENCODE_DATA_DIR = path.join(os.homedir(), '.local', 'share', 'opencode');
